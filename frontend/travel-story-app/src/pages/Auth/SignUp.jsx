...
Create an account to start documenting your travels and preserving your memories in your personal travel journal.          </p>
          </div>
        ...
        <div className="w-2/4 h-[75vh] bg-white rounded-r-lg  relative p-16 shadow-lg shadow-cyan-200/20">
          <form onSubmit={handleSignUp}>
            ...
            <button className='btn-primary btn-light' type='submit' onClick={() => { navigate("/login") }}>LOGIN</button>
          </form>
        </div>
      </div>
    </div>
