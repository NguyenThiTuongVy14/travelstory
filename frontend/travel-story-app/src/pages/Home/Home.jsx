...
import EmmptyImg from '../../assets/images/imgEmpty.svg'
...
const Home = () => {
  ...
  const getAllTravelStories = async () => {
    try {
      const response = await axiosInstance.get("/getAllTravelStories");
  ...
  const updateIsFavourite = async (storyData) => {
    ...
    try {
      const response = await axiosInstance.post("/updateFavourite/" + storyId,
  ...
  const deleteTravelStory = async (data) => {
    ...
    try {
      const response = await axiosInstance.post("deleteTravel/" + storyId);
        ...
        <div className='flex gap-7'>
          <div className='flex-1'>
            {allStories.length > 0 ? (
              ...
              <EmptyCard 
                imgScr={getEmptyCardImg(filterType)}
